...
// Color parentAppColor = Color(0xff02ADBA);
...
const String attendanceString = 'Attendance';
const String schoolServiceString = 'School Service';
const String schoolBulletinString = 'School Bulletin';
const String dateString = 'Date';
const String gradeString = 'Grade';

// Define your constant colors
const Color parentAppColor = Color(0xff02ADBA);
const Color adminAppColor = Color(0xffEF8515);
const MaterialColor adminMaterialColor = MaterialColor(0xFFEF8515, <int, Color>{
  50: Color(0xFF558B2F),
  100: Color(0xFF558B2F),
  // Include other shades if needed
});
const MaterialColor parentMaterialColor =
    MaterialColor(0xff38C0C6, <int, Color>{
  50: Color(0xFF558B2F),
  100: Color(0xFF558B2F),
  // Include other shades if needed
});
...
// Create a function for animated page routes
Future<void> animatedRoute(BuildContext context, Widget page) async {
